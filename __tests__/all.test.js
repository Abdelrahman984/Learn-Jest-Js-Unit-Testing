...
test("Check For Property Age Value Is 21", () => {
  let myObject = {
    name: "Abdelrahman",
    age: 21,
  };
  expect(myObject).toHaveProperty("age", 21);
});
...
test("Expect Anything", () => {
  let x = "A";
  expect("Abdelrahman").toEqual(expect.anything());
...
test("Expect Any Constructor", () => {
  ...
  expect("Abdelrahman").toEqual(expect.any(String));
});
